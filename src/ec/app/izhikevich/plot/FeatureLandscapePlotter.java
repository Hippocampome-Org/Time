...
public class FeatureLandscapePlotter {
	static boolean _3dPlot = true;
	static String fileName = "C:/gnu/10_2_3_A_feats/";
	//static String ipStartModel = "10_2_3/B1/2-003/art2";  //sfa.v3, sfa, trial 24, 96
	static String ipStartModel = "10_2_3/B4/3-000/4b";  //sfa.v3, fsl, trial 80
	//static String ipStartModel = "10_2_3/B3/2-043/13b2"; //fs, trial 4
	static int trial = 80;//24;//
	static int min_NSPIKES_for_measure = 3;
	...
	public static void main(String[] args) {
		...
		xParms[0] = 5.195543352576868;	//starting point	
		startingModel.setParm(xID, xParms);
		float stepSizeX = 0.1f;
		int nStepsX = 0;
	...
	static DataSetOfModels constructDataSetWithStepModelsAndFeature(Izhikevich9pModelMC model, 
		...
		{
			tempfeature= (float)evaluator.getSpEvalHolder().sfa_m1();
			//tempfeature= (float)evaluator.getSpEvalHolder().fsl();
			//tempfeature= (float)evaluator.getPtEvalHolder().minFreq();
		}
