...
public class CA3GC{
	private static final String INPUT = "input/TSTUT_ASP_NASP.input";	
	...
	private static void initGeneParmsOfModelParmsExceptI() {
		 ...
		 */
		initGeneParmForK(1,2,1,3);
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
	
		geneParms.put(ModelParameterID.A, new EAParmsOfModelParm("0.0001","0.02","gauss", 				COMMON_MUT_RATE,	"0.05",	"true" ));		
		geneParms.put(ModelParameterID.B, new EAParmsOfModelParm("0",		"5",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));		
		geneParms.put(ModelParameterID.D, new EAParmsOfModelParm("0",		"10",	"integer-random-walk",	COMMON_MUT_RATE,	"0.0", 	"true" ));		
		
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("300",	"500",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"true" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-79",	"-77",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("15",	"25",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("25",	"30",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
				
		/*
		 * different vpeaks for soma and dendrites; for spikeProp (contrary to bio realism)
		 */
		initGeneParmForVpeak(103, 105, 1, 20);
		
		//geneParms.put(ModelParameter.VPEAK, new EAParmsOfModelParm("58","60",	"gauss", 				"0.1", 	"0.3", 	"true" ));	//vr + gene	
		
		geneParms.put(ModelParameterID.G, new EAParmsOfModelParm(	"100",	"500",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0", 	"true" ));	
		geneParms.put(ModelParameterID.P, new EAParmsOfModelParm(	"0",	"1",	"gauss", 				COMMON_MUT_RATE, 	"0.1", "true" ));	
