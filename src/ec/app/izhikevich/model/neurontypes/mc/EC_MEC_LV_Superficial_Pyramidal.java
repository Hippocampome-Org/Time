...
public class EC_MEC_LV_Superficial_Pyramidal{
	private static final String INPUT = "input/ASP_SSLN.input";	
	...
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
		...
		geneParms.put(ModelParameterID.B, new EAParmsOfModelParm("0",		"25",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"false" ));		
		geneParms.put(ModelParameterID.D, new EAParmsOfModelParm("0",		"15",	"integer-random-walk",	COMMON_MUT_RATE,	"0.0", 	"false" ));		
		
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("50",	"100",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"true" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-68",	"-65",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("18",	"20",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("34",	"36",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
				
		/*
		 * different vpeaks for soma and dendrites;
		 */
		initGeneParmForVpeak(60, 62, 1, 20);
