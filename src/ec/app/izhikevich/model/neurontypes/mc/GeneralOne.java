...
public class GeneralOne{
	private static final String INPUT = "input/GeneralOne.input";	
	...
	private static void initGeneParmsOfModelParmsExceptI() {
		 ...
		 */
		initGeneParmForK(1,10,1,10);
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
	
		geneParms.put(ModelParameterID.A, new EAParmsOfModelParm("0.02","0.5","gauss", 				COMMON_MUT_RATE,	"0.05",	"true" ));		
		...
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("100",	"200",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"false" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-65",	"-61",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("15",	"20",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("20",	"25",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		
		/*
		 * different vpeaks for soma and dendrites; for spikeProp (contrary to bio realism)
		 */
		initGeneParmForVpeak(65, 80, 1, 20);
