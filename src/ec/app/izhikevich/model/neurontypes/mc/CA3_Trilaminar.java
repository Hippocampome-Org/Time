...
public class CA3_Trilaminar{
	private static final String INPUT = "input/TSTUT_SSLN.input";	
	private static final String COMMON_MUT_RATE = "0.1";
	...
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
		...
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("90",	"110",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"true" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-62",	"-60",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("15",	"16",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("31",	"32",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
				
		/*
		 * different vpeaks for soma and dendrites;
		 */
		initGeneParmForVpeak(85, 90, 1, 20);
