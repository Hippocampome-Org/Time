...
public class CA3bPyramidal23223p2{
	private static final String INPUT = "input/TSWB_SSLN.input";	
	private static final String COMMON_MUT_RATE = "0.3";
	...
	private static void initGeneParmsOfModelParmsExceptI() {
		 ...
		 */
		initGeneParmForK(1,3,1,10);
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
	
		geneParms.put(ModelParameterID.A, new EAParmsOfModelParm("0.000001","0.05","gauss", 				COMMON_MUT_RATE,	"0.03",	"true" ));		
		//geneParms.put(ModelParameter.B, new EAParmsOfModelParm("0",		"5",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"false" ));		
		/*
		 * for 3rd class - TSWB_SSLN type
		 */
		geneParms.put(ModelParameterID.B, new EAParmsOfModelParm("0",		"5",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"false" ));		
		geneParms.put(ModelParameterID.D, new EAParmsOfModelParm("0",		"20",	"integer-random-walk",	COMMON_MUT_RATE,	"0.0", 	"false" ));		
		
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("185",	"585",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"true" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-60",	"-56",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		
		//geneParms.put(ModelParameter.VMIN, new EAParmsOfModelParm("5",	"15",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		//geneParms.put(ModelParameter.VT, new EAParmsOfModelParm("15",	"25",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vmin + gene
		/*
		 * for 3rd class - TSWB_SSLN type
		 */
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("18",	"20",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("33",	"35",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
	
		/*
		 * different vpeaks for soma and dendrites; for spikeProp (contrary to bio realism)
		 */
		initGeneParmForVpeak(80, 90, 1, 20);
	...
	private static void initGeneParmForK(int somaMinGene, int somaMaxGene, int dendMinGene, int dendMaxGene){
		...
		geneParms.put(ModelParameterID.K, new EAParmsOfModelParm(	minGenes, maxGenes,	"gauss", 				COMMON_MUT_RATE, 	"0.3", 	"true" ));
