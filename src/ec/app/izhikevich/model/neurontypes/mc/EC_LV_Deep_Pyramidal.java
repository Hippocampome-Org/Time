...
public class EC_LV_Deep_Pyramidal{
	private static final String INPUT = "input/TSTUT_NASP.input";	
	private static final String COMMON_MUT_RATE = "0.6";
	...
	private static void initGeneParmsOfModelParmsExceptI() {
		 ...
		 */
		initGeneParmForK(0,10,1,3);
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
	
		geneParms.put(ModelParameterID.A, new EAParmsOfModelParm("0.0001","0.3","gauss", 				COMMON_MUT_RATE,	"0.05",	"true" ));		
		geneParms.put(ModelParameterID.B, new EAParmsOfModelParm("0",		"5",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"false" ));		
		geneParms.put(ModelParameterID.D, new EAParmsOfModelParm("0",		"10",	"integer-random-walk",	COMMON_MUT_RATE,	"0.0", 	"false" ));		
		
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("150",	"250",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"true" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-72",	"-70",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("1",	"3",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("8",	"10",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
				
		/*
		 * different vpeaks for soma and dendrites; for spikeProp (contrary to bio realism)
		 */
		initGeneParmForVpeak(75, 77, 1, 20);
