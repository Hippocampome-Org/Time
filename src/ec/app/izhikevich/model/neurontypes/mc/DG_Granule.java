...
public class DG_Granule{
	...
	//	geneParms.put(ModelParameter.K, new EAParmsOfModelParm("1",		"3",	"gauss",				"0.1",	"0.3",	"true" ));		
		...
		geneParms.put(ModelParameterID.CM, new EAParmsOfModelParm("50",	"300",	"integer-random-walk", 	COMMON_MUT_RATE, 	"0.0",	"true" ));		
		geneParms.put(ModelParameterID.VR, new EAParmsOfModelParm("-78",	"-76",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	
		geneParms.put(ModelParameterID.VMIN, new EAParmsOfModelParm("13",	"15",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
		geneParms.put(ModelParameterID.VT, new EAParmsOfModelParm("23",	"35",	"gauss", 				COMMON_MUT_RATE,	"0.3", 	"true" ));	//vr + gene
				
		/*
		 * different vpeaks for soma and dendrites;
		 */
		initGeneParmForVpeak(109, 110, 1, 20);
